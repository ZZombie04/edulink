...
export const jobPosts: JobPost[] = [
  {
    ...
    gradeLevel: "3학년 담임",
    isHomeroom: true,
    summary: "출산휴가 대체로 3학년 담임과 생활지도를 함께 맡아주실 선생님을 찾습니다.",
    duties: [
      "3학년 담임 및 학급 운영",
      "국어, 수학, 사회 교과 지도",
      "학부모 상담과 기초학력 보정 지도",
  ...
  },
  {
    ...
    gradeLevel: "1학년 교과",
    isHomeroom: false,
    summary: "중1 수학 수업과 방과후 보충지도를 맡아주실 시간강사를 모집합니다.",
    duties: [
      "주 14시간 수학 교과 수업",
      "평가 문항 검토 및 과제 피드백",
      "방과후 보충수업 1시간 운영",
  ...
  },
  {
    ...
    gradeLevel: "2학년 담임",
    isHomeroom: true,
    summary: "학년 담임과 영어 수업 운영 경험이 있는 선생님을 우선 검토합니다.",
    duties: [
      "2학년 담임 및 생활교육",
      "주당 16시간 영어 수업 운영",
      "학년부 협업과 진학 상담",
...
export const hrMatchRequests = [
  ...
  },
  {
    id: 2,
    teacherName: "이준호",
    qualification: "중등 수학 1정교사",
    status: "accepted" as const,
    sentAt: "어제",
    position: "한빛중학교 수학 시간강사",
  },
  {
    id: 3,
    teacherName: "김도현",
